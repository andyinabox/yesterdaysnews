...
export const loadingIcon = () => {
  return html`
    <svg version="1.1" xmlns="http://www.w3.org/2000/svg" viewbox="0 0 500 500">
      <path
        class="wave1"
        d="M50,250H10c0-64.1,25-124.4,70.3-169.7S185.9,10,250,10v40c-110.3,0-200,89.7-200,200Z"
      />
      <path
        class="wave2"
        d="M122.1,250h-40c0-92.6,75.3-167.9,167.9-167.9v40c-70.5,0-127.9,57.4-127.9,127.9Z"
      />
      <path
        class="wave3"
        d="M192.2,250h-37.9c0-52.7,42.9-95.7,95.7-95.7v37.9c-31.8,0-57.8,25.9-57.8,57.8h0Z"
      />
      <path
